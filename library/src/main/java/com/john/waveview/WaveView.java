...
public class WaveView extends LinearLayout {
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        mAboveWaveAlpha = attributes.getInt(R.styleable.WaveView_above_wave_alpha, DEFAULT_ABOVE_WAVE_ALPHA);
        mBlowWaveAlpha = attributes.getColor(R.styleable.WaveView_blow_wave_alpha, DEFAULT_BLOW_WAVE_ALPHA);
        ...
        mWave.setAboveWaveAlpha(mAboveWaveAlpha);
        mWave.setBlowWaveAlpha(mBlowWaveAlpha);
